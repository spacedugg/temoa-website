# temoa Website, Copy (Master-Dokument)
...
## Navigation (sticky)
Logo: temoa
Menü: Full Service (Mega-Menü, 5 Services, selbst klickbar zur Übersichtsseite) | Case Studies | Designbeispiele
CTA: Potenzialanalyse buchen
Mega-Menü Full Service: Strategie & Analyse | Content & Listings | Advertising / PPC | Account-Management | Internationalisierung | Alle Leistungen ansehen

## 1 · Hero
- Eyebrow: Amazon Full Service Wachstumspartner
- Headline: Amazon-Wachstum ist keine Frage des Werbebudgets.
- Subline: Wir machen euer Listing organisch so stark, dass es auch ohne Werbung verkauft. Erst dann kommt PPC dazu und arbeitet vom ersten Euro an profitabel.
- CTA primär: Potenzialanalyse buchen
- CTA sekundär: Case Studies ansehen
- Visual: [Platzhalter Hero-Bild, liefert Kunde]

## 2 · Credibility-Band
- [Platzhalter: Logo-Reihe Kundenmarken]
- Ø +30 % Profitabilitätssteigerung
- 21 Mio. € betreuter Amazon-Jahresumsatz
- 60+ betreute Marken
- 5+ internationale Marktplätze
...
- Content nicht KI-ready. Rufus und COSMO bewerten Listings anders als früher. Wer das ignoriert, verliert organische Sichtbarkeit.
- Launches starten blind. Neue Produkte ohne Wettbewerbs-Analyse: langer Anlauf, später Break-even.
- Alles hängt an einer Person. Fällt sie aus, steht Amazon still.
Bridge: Das bekämpft nur Symptome. Die Ursache bleibt: ein Listing, das organisch nicht verkauft.

## 4 · Mechanismus
- Eyebrow: Unser Ansatz
- Headline: Organic First, PPC Second.
- Text:
  Zuerst bauen wir ein Listing, das verkauft: stark auf Klickrate und Conversion, die wichtigsten Signale für Amazons Ranking. Retail Ready heißt, aus Besuchern werden Käufer, auch ohne Werbung.
  Wer Wachstum nur über Werbung kauft, bleibt abhängig: Klicks werden jedes Jahr teurer, die Margen enger. Wir drehen die Spirale um. Erst das organische Fundament, dann profitabel skalieren, gesteuert über euren TACoS. Profitabilität vor Umsatz.
- Visual: Sichtbarkeit > Klickrate > Conversion
- Alt/Neu (als gestaltete Gegenüberstellung umsetzen, nicht als nackte Tabelle):

| Wie es jetzt läuft | Wie temoa arbeitet |
|---|---|
| Bilder, Texte und Titel einmal erstellt, dann läuft Werbung | Listing auf CTR und Conversion optimiert, bis es organisch verkauft |
| Content nach Standard, ohne Datenbasis | Content aus Search Query Report, Wettbewerb und Bewertungen |
| Abhängig von PPC, Klicks werden jährlich teurer | Organisch unabhängig, PPC profitabel statt teuer |
| Umsatz um jeden Preis | Profitabilität als Maßstab (TACoS) |

## 5 · Full Service
- Eyebrow: Full Service
- Headline: Fünf Leistungen, in der richtigen Reihenfolge.
...
Hauptbild und Produktbilder, Amazon A+ bis Premium A+ Content, Brand Store und Markengeschichte. Dazu SEO über Titel, Bullets und Backend. Alles datenbasiert und KI-ready für Rufus, COSMO und A10 gebaut, bis das Listing auch organisch verkauft.
Hauptbild & Produktbilder · Amazon A+ und Premium A+ · Brand Store & Markengeschichte · SEO (Titel, Bullets, Backend) · Retail Readiness für Launches
...
Inventar & Forecasting · Buy-Box-Überwachung · Reporting · Account-Health & Cases

5 Internationalisierung: Lokalisieren statt übersetzen.
Was in einem Markt verkauft, rollen wir auf weitere aus, EU und US. Listings und Kampagnen passen wir an jeden Marktplatz an.
Rollout EU & US · Lokalisierung · marktspezifische Listings & Kampagnen

CTA: Alle Leistungen ansehen

## 6 · Case Studies (4 nebeneinander, mobil untereinander)
- Headline: Ergebnisse statt Versprechen.
- Sub: Vier Marken, vier Ausgangslagen.
- Pro Karte: [Logo/Marke] · Start: [Ausgangslage] · Was wir taten: [Maßnahme] · Ergebnis: [Kennzahl] · [Zeitraum]
- Schwerpunkte: Profitabilität (TACoS) · organisches Ranking · Launch / Retail Readiness · Internationalisierung
- Kandidaten aus Testimonials: Vita-World (5k auf 16k Bestellungen, +50 % CVR, TACoS 5,8 %), Greenfood (Umsatz x2 in 6 Monaten), Bachgold (Nische Wasserfilter, #1, US-Launch)
- [Echte Daten und Kundenfreigabe nötig]

## 7 · Designbeispiele
- Headline: So sieht Retail Ready aus.
- Sub: Ein komplettes Listing, vom Hauptbild bis zum A+ Content.
- [Listing: 1 Hauptbild + 6 Listingbilder als Set, daneben A+ Content schwebend in 3D mit weichen Schatten]
- CTA: Mehr Designbeispiele
...
4. 5 Sterne, Dennis Hoheusel, GF FUTUM Handels GmbH: „Wir waren überrascht, wie viel man allein durch bessere Listings und gezielten Content rausholen kann, und das sieht man direkt in den Zahlen."
5. 5 Sterne, Gianluca G., GF P+G E-Com GbR: „Die Performance der Ergebnisse war hervorragend, Branding und Design passen perfekt zusammen."
6. 5 Sterne, Gilbert Baeumer, GF Baeumer Online GmbH: „Bisher sind alle Artikel, die wir mit temoa erstellt und bei Amazon gelistet haben, eingeschlagen. Ich werde weitere Produkte mit euch umsetzen!"
7. 5 Sterne, Markus Bieletzki, Gründer badSTARK: „Ich war extrem zufrieden: kurzer Draht und top Ergebnisse."

## 9 · Finaler CTA
- Headline: Wie viel Umsatz lässt euer Listing liegen?
- Sub: Das zeigen wir euch in einer kostenlosen Potenzialanalyse.
- Risk-Reversal: Ohne lange Vertragslaufzeiten. 98 % Kundenbindung.
- CTA: Potenzialanalyse buchen

## 10 · Team (nach dem CTA)
- Headline: Das Team hinter temoa.
- Nebensatz: Amazon-Spezialisten, die eure Marke kennen wie die eigene.
- [Platzhalter Teambilder]

## 11 · Blog-Streifen
- Eyebrow: Wissen
- Headline: Klartext zu Amazon.
- [4 Artikel-Platzhalter, Themen liefert Kunde]

## 12 · Footer
- temoa · Amazon Full Service Wachstumspartner
- Leistungen: Strategie & Analyse · Content & Listings · Advertising / PPC · Account-Management · Internationalisierung
- Unternehmen: Case Studies · Designbeispiele · Blog
- Rechtliches: Impressum · Datenschutz
- Kontakt: [E-Mail]
- Copyright [Jahr] temoa

---
---

# SEITE 2: LEISTUNGSSEITE (Full Service)

Differenzierung über die Tiefe der Umsetzung, nicht über „wir machen alles", nicht über Reihenfolge. Scannbar in Sektionen und Karten, keine Tabelle.

## 1 · Header
- Eyebrow: Full Service
- Headline: Ein eingespieltes Team für euren kompletten Amazon-Account.
- Subline: Done-for-you, kein Ratschlag zum Selbermachen. Wir übernehmen jeden Bereich und führen ihn mit einer Tiefe, die intern selten zusammenkommt.
- CTA: Potenzialanalyse buchen
- [Visual-Platzhalter]

## 2 · Für wen (Überschrift als Frage, vier Karten)
- Eyebrow: Für wen
- Headline: Passt das zu eurer Marke?
- Karte: Etabliertes Sortiment. Eigene Marke, ernsthafter Umsatz, aber Luft nach oben.
- Karte: Amazon-Wissen fehlt im Haus. Die Produkte sind stark, das Plattform-Know-how noch nicht.
- Karte: Schnelles Wachstum. Das Sortiment wächst schneller als die interne Kapazität.
- Karte: Viele SKUs, mehrere Marktplätze. Komplexität, die nebenher nicht sauber zu führen ist.

## 3 · Das Problem der Alternativen (drei Karten + Callout)
- Eyebrow: Die Ausgangslage
- Headline: Warum die üblichen Lösungen an Amazon scheitern.
- Karte: Internes Team zu klein. Das Wissen fehlt oder liegt bei einer Person. Fällt sie aus, steht Amazon.
- Karte: Einzeldienstleister, getrennte Sicht. Einer steuert PPC nur auf Werbeausgaben, einer baut Content ohne Blick auf den Bestand. Die Gesamtstrategie verantwortet niemand.
- Karte: Amazon ist ein Vollzeitjob. 20 bis 40 Stunden pro Woche auf einer Plattform, die sich ständig verändert.
- Callout: Die größten Verluste entstehen bei Chancen, die intern nie auffallen.

## 4 · Die fünf Leistungen (alternierende Bild/Text-Reihen)
Intro: Eyebrow „Was wir übernehmen", Headline „Fünf Bereiche, jeder in voller Tiefe."

01 Strategie & Analyse [Bild]
- Überschrift: Wir lesen euren Markt bis auf den einzelnen Suchbegriff.
...
02 Content & Listings [Bild]
- Überschrift: Ein Listing, das auch ohne Werbung verkauft.
...
03 Advertising / PPC [Bild]
- Überschrift: Saubere Kampagnen, gesteuert am TACoS.
...
04 Account-Management [Bild]
- Überschrift: Stabiler Betrieb, geschützte Rankings.
...
05 Internationalisierung [Bild]
- Überschrift: Das erprobte Setup auf neue Marktplätze ausgerollt.
- Zeile: Der komplette, erprobte Service, effizient auf weitere Marktplätze übertragen.
...
## 5 · Reporting (schmaler Akzent-Streifen)
- Eyebrow: Immer enthalten
- Headline: Reporting, das ihr in fünf Minuten versteht.
- Monatliche Performance-Reports · Profit- und Verlust-Analyse · Markttrends und Wettbewerbsbeobachtung

## 6 · Der Unterschied (zusammenhängende Sektion, keine Tabelle)
- Eyebrow: Der Unterschied
- Headline: Eine Strategie über alle Bereiche, statt isolierter Einzelmaßnahmen.
...
## 7 · Finaler CTA
- Headline: Wir zeigen euch, wo in eurem Account das Wachstum liegt.
