...
/** Soft, slowly drifting gradient glows for premium depth. */
  ...
  return (
    <div className={clsx("pointer-events-none absolute inset-0 overflow-hidden", className)} aria-hidden>
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(98,88,247,0.40), transparent 60%)" }}
      ...
      <motion.div
        ...
        style={{ background: "radial-gradient(circle, rgba(151,71,255,0.38), transparent 60%)" }}
        animate={{ x: [0, -50, 20, 0], y: [0, 30, -20, 0], scale: [1, 0.92, 1.08, 1] }}
        transition={{ duration: 26, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute bottom-[-15%] left-[30%] h-[34rem] w-[34rem] rounded-full opacity-40 blur-3xl"
        style={{ background: "radial-gradient(circle, rgba(34,211,238,0.34), transparent 60%)" }}
