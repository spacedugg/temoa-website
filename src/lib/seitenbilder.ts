...
const FESTE_SEITEN: Record<string, string[]> = {
  "/": [
    /* Das Hero-Bild. Es gab es eine Zeit lang in zwei Sprachfassungen, weil
       die Beschriftung darin steckt; der Kunde hat ein einzelnes Bild fuer
       beide vorgegeben. Kommt die englische Fassung zurueck, gehoert sie hier
       daneben, sonst stuende sie in keiner Sitemap. */
